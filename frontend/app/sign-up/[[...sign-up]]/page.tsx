        ...
        <div className="w-full max-w-md">
          ...
          <div className="panel text-center">
            ...
            <p className="text-muted text-sm mb-5">
              ...
              <code className="font-mono text-xs bg-surface2 px-1 py-0.5 rounded">.env.local</code> to enable sign-up.
            </p>
            <Link
              href="/dashboard"
    ...
    >
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-xs text-dim mt-5">
          ...
          <Link href="/sign-in" className="text-blue hover:underline">
            Sign in
          </Link>
        </p>
      </div>
